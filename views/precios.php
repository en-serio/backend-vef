...
<div class="row">
    <div class="col-6">
        <form id="priceForm" method="post">
            ...
            <!-- ID Hotel -->
            <div class="mb-3">
                <label for="idHotel" class="form-label">ID Hotel</label>
                <input type="number" class="form-control form-control-lg" id="idHotel" name="idHotel" required>
            </div>
