...
class otroTransfer {
    ...
    public function updateZona($descripcion, $id){
        ...
        if(!$stmt){
            echo json_encode([
                'error' => true,
                'message' => 'Error al actualizar la zona ' . $this->conn->error
            ]);
        }
        ...
        if($stmt->execute()){
            ...
            echo json_encode([
                'error' => true,
                'message' => 'Error al actualizar la zona ' . $stmt->error
            ]);
        }
    }
    ...
    public function updateTipo($descripcion, $id){
        ...
        if(!$stmt){
            echo json_encode([
                'error' => true,
                'message' => 'Error al actualizar el tipo ' . $this->conn->error
            ]);
        }
        $stmt->bind_param('si', $descripcion, $id);
        if($stmt->execute()){
    ...
    public function updateHotel(){
        ...
        if($stmt->execute()){
            ...
            echo json_encode([
                'error' => true,
                'message' => 'Error al actualizar el hotel ' . $stmt->error
            ]);
        }
    }
    ...
    public function postZona($descripcion){
        ...
        if (!$stmt) {
            echo json_encode([
                'error' => true,
                'message' => 'Error al crear la zona ' . $this->conn->error
            ]);
        }
